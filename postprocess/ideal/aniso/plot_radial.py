...
gd= pd.read_csv("../../../ideal/ANISOTROPIC/d/radial.csv", ",", skiprows=0)
gm= pd.read_csv("../../../ideal/ANISOTROPIC/m/radial.csv", ",", skiprows=0)
gp= pd.read_csv("../../../ideal/ANISOTROPIC/p/radial.csv", ",", skiprows=0)
gt= pd.read_csv("../../../ideal/ANISOTROPIC/t/radial.csv", ",", skiprows=0)
ge= pd.read_csv("../../../ideal/ANISOTROPIC/e/radial.csv", ",", skiprows=0)

fig1 = plt.figure( dpi=300)
lwh = 2
axes = fig1.add_axes([0.15, 0.15, 0.7, 0.7]) #size of figure
axes.plot(refer.iloc[:,7] , refer.iloc[:,0]/refer.iloc[0,0], 'k', lw=lwh, label="reference")
axes.plot(gd.iloc[:,7] , gd.iloc[:,0]/refer.iloc[0,0] , 'r', lw=lwh, label="aniso  $\\rho$")
...
axes.plot(gt.iloc[:,7] , gt.iloc[:,0]/refer.iloc[0,0] , 'r--', lw=lwh, label="aniso  T")
axes.plot(ge.iloc[:,7] , ge.iloc[:,0]/refer.iloc[0,0] , 'b--', lw=lwh, label="aniso  s")
...
axes.plot(gd.iloc[:,7] , gd.iloc[:,1], 'r', lw=lwh, label="aniso  $\\rho$")
axes.plot(gm.iloc[:,7] , gm.iloc[:,1], 'b', lw=lwh, label="aniso  M")
axes.plot(gp.iloc[:,7] , gp.iloc[:,1], 'k--', label="aniso  P")
...
axes.plot(gd.iloc[:,7] , gd.iloc[:,3]/refer.iloc[0,3] , 'r', lw=lwh, label="aniso  $\\rho$")
...
axes.plot(gt.iloc[:,7] , gt.iloc[:,3]/refer.iloc[0,3] , 'r--', lw=lwh, label="aniso  T")
axes.plot(ge.iloc[:,7] , ge.iloc[:,3]/refer.iloc[0,3] , 'b--', lw=lwh, label="aniso  s")
