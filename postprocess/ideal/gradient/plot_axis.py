...
gd= pd.read_csv("../../../ideal/GRADIENT/DENSITY/axis.csv", ",", skiprows=0)
gm= pd.read_csv("../../../ideal/GRADIENT/MACH/axis.csv", ",", skiprows=0)
gp= pd.read_csv("../../../ideal/GRADIENT/PRESSURE/axis.csv", ",", skiprows=0)
gt= pd.read_csv("../../../ideal/GRADIENT/TEMPERATURE/axis.csv", ",", skiprows=0)
ge= pd.read_csv("../../../ideal/GRADIENT/e/axis.csv", ",", skiprows=0)
...
axes.plot(ge.iloc[:,6] , ge.iloc[:,2]/gt.iloc[0,2] , 'b--', lw=lwh, label="$\\nabla s$")
