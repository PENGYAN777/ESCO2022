...
refer= pd.read_csv("../../../../nonideal/mm/reference/axis.csv", ",", skiprows=0)
gd= pd.read_csv("../../../../nonideal/mm/hessian/d/axis.csv", ",", skiprows=0)
gm= pd.read_csv("../../../../nonideal/mm/hessian/m/axis.csv", ",", skiprows=0)
gp= pd.read_csv("../../../../nonideal/mm/hessian/p/axis.csv", ",", skiprows=0)
gt= pd.read_csv("../../../../nonideal/mm/hessian/t/axis.csv", ",", skiprows=0)
ge= pd.read_csv("../../../../nonideal/mm/hessian/e/axis.csv", ",", skiprows=0)
...
axes.plot(gd.iloc[:,6] , gd.iloc[:,2]/gd.iloc[0,2] , 'r', lw=lwh, label="$H(\\rho)$")
...
fig1.savefig("refer_mm_hes_p.pdf")
