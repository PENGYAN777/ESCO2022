...
refer= pd.read_csv("../../../../nonideal/mm/reference/radial.csv", ",", skiprows=0)
refer_pr= pd.read_csv("refer_radial.csv", ",", skiprows=0)
gd= pd.read_csv("../../../../nonideal/mm/gradient/d/radial.csv", ",", skiprows=0)
gm= pd.read_csv("../../../../nonideal/mm/gradient/m/radial.csv", ",", skiprows=0)
gp= pd.read_csv("../../../../nonideal/mm/gradient/p/radial.csv", ",", skiprows=0)
gt= pd.read_csv("../../../../nonideal/mm/gradient/t/radial.csv", ",", skiprows=0)
ge= pd.read_csv("../../../../nonideal/mm/gradient/e/radial.csv", ",", skiprows=0)


fig1 = plt.figure( dpi=300)
lwh = 2
axes = fig1.add_axes([0.15, 0.15, 0.7, 0.7]) #size of figure
axes.plot(refer.iloc[:,7] , (refer.iloc[:,0]+2*refer_pr.iloc[:,0])/3/refer.iloc[0,0], 'k', lw=lwh, label="reference")
...
axes.set_title('$\\rho/\\rho_t$ at $X=8[mm]$',fontsize=14)
...
# axes.set_aspect('equal', 'box')
axes.set_title('Mach at $X=8[mm]$',fontsize=14)
...
# axes.set_aspect('equal', 'box')
axes.set_title('$T/T_t$ at $X=8[mm]$',fontsize=14)
