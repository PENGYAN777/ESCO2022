...
gd= pd.read_csv("../../../../nonideal/mm/gradient/d/axis.csv", ",", skiprows=0)
gm= pd.read_csv("../../../../nonideal/mm/gradient/m/axis.csv", ",", skiprows=0)
gp= pd.read_csv("../../../../nonideal/mm/gradient/p/axis.csv", ",", skiprows=0)
gt= pd.read_csv("../../../../nonideal/mm/gradient/t/axis.csv", ",", skiprows=0)
ge= pd.read_csv("../../../../nonideal/mm/gradient/e/axis.csv", ",", skiprows=0)
...
axes.plot(ge.iloc[:,6] , ge.iloc[:,2]/ge.iloc[0,2] , 'b--', lw=lwh, label="$\\nabla s$")
