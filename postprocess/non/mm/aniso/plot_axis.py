...
gd= pd.read_csv("../../../../nonideal/mm/aniso/d/axis.csv", ",", skiprows=0)
gm= pd.read_csv("../../../../nonideal/mm/aniso/m/axis.csv", ",", skiprows=0)
gp= pd.read_csv("../../../../nonideal/mm/aniso/p/axis.csv", ",", skiprows=0)
gt= pd.read_csv("../../../../nonideal/mm/aniso/t/axis.csv", ",", skiprows=0)
ge= pd.read_csv("../../../../nonideal/mm/aniso/e/axis.csv", ",", skiprows=0)
