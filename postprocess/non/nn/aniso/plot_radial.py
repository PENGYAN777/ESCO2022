...
gd= pd.read_csv("../../../../nonideal/nn/aniso/d/radial.csv", ",", skiprows=0)
gm= pd.read_csv("../../../../nonideal/nn/aniso/m/radial.csv", ",", skiprows=0)
gp= pd.read_csv("../../../../nonideal/nn/aniso/p/radial.csv", ",", skiprows=0)
gt= pd.read_csv("../../../../nonideal/nn/aniso/t/radial.csv", ",", skiprows=0)
ge= pd.read_csv("../../../../nonideal/nn/aniso/e/radial.csv", ",", skiprows=0)
