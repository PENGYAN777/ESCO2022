...
ge= pd.read_csv("../../../../nonideal/nn/hessian/e/radial.csv", ",", skiprows=0)
...
axes.plot(ge.iloc[:,7] , ge.iloc[:,0]/refer.iloc[0,0]*11.2675 , 'b--', lw=lwh,  label="$H(s)$")
...
# axes.set_ylim(0.2,1)
#axes.legend(loc=2) # 2 means left top
fig2.savefig("refer_nn_hes_m.pdf")
...
# axes.set_ylim(0.2,1)
#axes.legend(loc=2) # 2 means left top
fig3.savefig("refer_nn_hes_t.pdf")
