...
sed -i 's/^\s*MARKER_RIEMANN=.*$/MARKER_RIEMANN= ( 1, TOTAL_CONDITIONS_PT, 8e6, 250, 1.0, 0.0, 0.0, 4, TOTAL_CONDITIONS_PT, 1e6, 300, 1.0, 0.0, 0.0, 5, STATIC_PRESSURE, 1e6, 0.0, 0.0, 0.0, 0.0 )/' su2.cfg
