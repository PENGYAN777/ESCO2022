...
#sed -i 's/^\s*FREESTREAM_PRESSURE=.*$/FREESTREAM_PRESSURE=3.2e5/' su2.cfg
#sed -i 's/^\s*MARKER_RIEMANN=.*$/MARKER_RIEMANN= ( 1, TOTAL_CONDITIONS_PT, 1.7e6, 500, 1.0, 0.0, 0.0, 4, TOTAL_CONDITIONS_PT, 3.2e5, 300, 1.0, 0.0, 0.0, 5, STATIC_PRESSURE, 3.2e5, 0.0, 0.0, 0.0, 0.0 )/' su2.cfg
